...
class myInProgressOrders extends StatefulWidget {
  ...
  myInProgressOrders({Key key, this.len}) : super(key: key);
  @override
  _myInProgressOrdersState createState() => _myInProgressOrdersState();
}

class _myInProgressOrdersState extends State<myInProgressOrders>
    with TickerProviderStateMixin {
  var tabs = List<Tab>.generate(
    1,
    (int index) {
     var indexTabName = index++;
      return new Tab(text: "Pack $indexTabName");}
  );
